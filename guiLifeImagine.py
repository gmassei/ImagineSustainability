...
class guiLifeImagineDialog(QDialog):
    """Main gui control"""
    ...
    def removePage(self):
        ...
        if idTab==0:
            QMessageBox.warning(self.iface.mainWindow(), "LifeImagine",
    ...
    def addAnalisysPage(self):
        """Add Analysis page """
        analysis=LifeImagineAnlisys(self.activeLayer,self.parameterList)
